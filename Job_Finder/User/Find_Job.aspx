<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Find_Job.aspx.cs" Inherits="Job_Finder.User.Find_Job" %>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4">
                                ...
                                <div class="select-job-items2">
                                    <select name="select">
                                        ...
                                        <!-- Select job items start -->
                                        <div class="select-job-items2">
                                            <asp:DropDownList ID="ddlCountry" runat="server" CssClass="nice-select"
                                                DataSourceID="SqlDataSource1" AppendDataBoundItems="true" DataTextField="Country"
                                                DataValueField="Country" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AutoPostBack="true">
                                ...
                                <div class="select-job-items2">
                                    ...
                                    <div class="single-listing">
                                        <!-- select-Categories start -->
                                        <div class="select-Categories pb-10">
                                            <div class="small-section-tittle2">
                                                <h4>Posted Within</h4>
                                            </div>
                                            <asp:CheckBoxList ID="CheckBoxList2" runat="server" CssClass="checkboxlist"
                                                ...
                                                AutoPostBack="true">
                                                <asp:ListItem Selected="true" Value="0" onclick="MutExChkList(this);">Any</asp:ListItem>
                                                <asp:ListItem Value="1" onclick="MutExChkList(this);">Today</asp:ListItem>
                                                <asp:ListItem Value="2" onclick="MutExChkList(this);">Last 2 days</asp:ListItem>
                                                <asp:ListItem Value="3" onclick="MutExChkList(this);">Last 3 days</asp:ListItem>
                                                <asp:ListItem Value="4" onclick="MutExChkList(this);">Last 5 days</asp:ListItem>
                                                <asp:ListItem Value="5" onclick="MutExChkList(this);">Last 10 days</asp:ListItem>
                                            </asp:CheckBoxList>
                                            <%--<label class="container">
                                        Any
                                        <input type="checkbox">
                                    ...
                                    <div class="single-listing">
                                        ...
                                        <aside class="left_widgets p_filter_widgets price_rangs_aside sidebar_box_shadow">
                                            <div class="form-group mt-4 text-center">
                                                <asp:Button CssClass="button button-contactForm boxed-btn" ID="btnAFilter" runat="server" Text="All Filter" OnClick="btnAFilter_Click" />
                                            </div>
                                            <div class="form-group mt-3 text-center">
                                                <asp:Button CssClass="button button-contactForm boxed-btn" ID="Button2" runat="server" Text="Reset" OnClick="btnReset_Click" />
                                            </div>
                                            <%--<div class="small-section-tittle2">
                                        <h4>Filter Jobs</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="count-job mb-35">
                                                    ...
                                                    <asp:Label ID="lbljobCount" runat="server" CssClass="span"></asp:Label>
                                                    <!-- Select job items start -->
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div class="single-job-items mb-30">
                                                    ...
                                                    <div class="items-link items-link2 f-right">
                                                        ...
                                                        <span><%# relativeDate(Convert.ToDateTime(Eval("CreateDate"))) %></span>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
                                        </asp:DataList>
