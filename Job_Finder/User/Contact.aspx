<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Job_Finder.User.Contact" %>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="hero-cap text-center">
                                        <h2>Contact us/ Register complain</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="form-contact contact_form" id="contactForm">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control valid" runat="server" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your or company name'" placeholder="Enter your name" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group mt-3">
                                        <%--<button type="submit" class="button button-contactForm boxed-btn" id="cBtnSend" runat="server" onclick="cBtnSend_Click()">Send</button>--%>
                                        <asp:Button CssClass="button button-contactForm boxed-btn" ID="cBtnSend" runat="server" Text="Send" OnClick="cBtnSend_Click" />
                                        <asp:Label ID="rlb" CssClass="ml-20 text-center" runat="server" Visible="false"></asp:Label>
                                    </div>
                                </div>
                            </div>
